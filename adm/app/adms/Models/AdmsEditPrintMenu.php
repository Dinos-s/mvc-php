...
class AdmsEditPrintMenu {
    ...
    public function editPrintMenu(int $id): void
    {
        ...
        $viewPrintMenu->fullRead(
            ...
            AND (((SELECT permission FROM adms_levels_pages WHERE adms_page_id=lev_pg.adms_page_id AND adms_access_level_id = {$_SESSION['adms_access_levels_id']}) = 1) OR (publish = 1))
            LIMIT :limit", 
