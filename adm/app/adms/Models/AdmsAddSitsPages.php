...
class AdmsAddSitsPages
{
    ...
    private function add(): void
    {
        ...
        $createSitUser->exeCreate("adms_sits_pgs", $this->data);

        if ($createSitUser->getResult()) {
            $_SESSION['msg'] = "<p style='color: green;'>Situação da página cadastrada com sucesso!</p>";
            $this->result = true;
        } else {
            $_SESSION['msg'] = "<p style='color: #f00;'>Erro: Situação da página não cadastrada com sucesso!</p>";
            $this->result = false;
        }
    }
