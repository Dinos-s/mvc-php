...
<h1>Cadastrar Situação da Página</h1>

<?php
echo "<a href='" . URLADM . "list-sits-pages/index'>Listar</a><br><br>";
...
<form method="POST" action="" id="form-add-sit-pages">
    <?php
    $name = "";
    ...
    <input type="text" name="name" id="name" placeholder="Digite o nome da situação da página" value="<?php echo $name; ?>" required><br><br>
    ...
    <button type="submit" name="SendAddSitsPages" value="Cadastrar">Cadastrar</button>
</form>