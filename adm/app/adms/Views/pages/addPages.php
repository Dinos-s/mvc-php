...
<?php
echo "<a href='" . URLADM . "list-pages/index'>Listar</a><br><br>";
...
<form method="POST" action="" id="form-add-pages">
    <?php
    $name_page = "";
    ...
    <button type="submit" name="SendAddPages" value="Cadastrar">Cadastrar</button>
</form>